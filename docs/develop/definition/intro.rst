...
Y es que cada vez que persistimos datos también persistimos *ideas* y *significados*, los cuales **deben ser re-interpretados más tarde** por otras personas (o máquinas). Esto sería trivial si existiera un significado único, pero en general los datos capturan la realidad con cierta *distancia digital*. Esta distancia, analogá al concepto de *distancia congnitiva*, representa una tensión interna entre lo que se cree que se alamacena y lo que efectivamente se almacena. Más aún, tal distancia no es estática sino que varía en el tiempo ya que la realidad es un *moving target*. El mantenimiento de estos datos así como también el de los sistemas que los instancian es una tarea que - ademas de resultar nada sencilla - también puede alterar el significado.
