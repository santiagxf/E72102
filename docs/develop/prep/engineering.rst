...
:Búsqueda: Buscan una combinación de predictores utilizando métodos de búsqueda. Este subset luego se evalúa o bien utilizando algún criterio o contra la tarea especifica. Vea :doc:`selection` para más detalle.
